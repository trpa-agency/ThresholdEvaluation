# all utility functions into a single file called utils.py in the same directory as water_quality.py, etc...
# and then import the functions from utils.py into water_quality.py, etc..
...
# function to get sql connection for tabular TRPA data
